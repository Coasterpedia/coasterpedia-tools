    ...
    public static MudTheme ApplicationTheme()
    {
        var theme = new MudTheme
        {
            ...
            Shadows = new Shadow
            {
                ...
                [
                    "none",
                    "0 3px 6px rgba(0,0,0,0.04),0 3px 6px rgba(0,0,0,0.0575)",
                    "none",
                    "none",
                    "none",
                    "none",
            ...
            Typography = new Typography
            {
                Default = new DefaultTypography
                {
                    ...
                    FontFamily =
                    [
                        "Inter var", "Inter", "ui-sans-serif", "system-ui", "-apple-system", "Segoe UI", "Roboto", "Helvetica Neue", "Arial", "Noto Sans",
